        ...
        <div className="mx-auto w-full max-w-[550px] bg-white dark:bg-gray-800">
          ...
          >
            ...
            <div className="mb-5 mt-10">
              <label
                htmlFor="subject"
                className="mb-1 block text-base text-[14px] text-red-500 dark:text-red-400"
              >
              ...
              <div className="flex flex-col md:flex-row justify-center gap-5">
                <input
                  ...
                  className="rounded-md border border-[#e0e0e0] bg-white dark:bg-gray-700 py-3 px-6 text-base font-small text-[#6B7280] dark:text-gray-200 outline-none focus:border-[#6A64F1] focus:shadow-md"
                ></input>
                <div
                  className="hover:shadow-form rounded-md cursor-pointer bg-[#6A64F1] dark:bg-indigo-600 py-3 px-8 text-center text-base font-semibold text-white outline-none"
                  onClick={addSubject}
                >
            ...
            <div className="mb-6 pt-4 cursor-pointer">
              <label className="mb-5 block text-xl font-semibold text-[#07074D] dark:text-gray-200">
              ...
              <div className="mb-8 cursor-pointer">
                ...
                <label
                  htmlFor="file"
                  className="relative flex min-h-[200px] items-center justify-center rounded-md border border-dashed border-[#e0e0e0] dark:border-gray-600 p-12 text-center"
                >
                  <div className="cursor-pointer">
                    <span className="mb-2 block text-xl font-semibold text-[#07074D] dark:text-gray-200">
                      {selectedFile.name || "Drop files here"}
                    </span>
                    <span className="mb-2 block text-base font-small text-[#6B7280] dark:text-gray-200">
                      Or
                    </span>
                    <span className="inline-flex rounded border border-[#e0e0e0] dark:border-gray-600 py-2 px-7 text-base font-small text-[#07074D] dark:text-gray-200">
                      Browse
                    </span>
                  </div>
                </label>
              ...
              {selectedFile.name && (
                <div className="mb-5 rounded-md bg-[#F5F7FB] dark:bg-gray-700 py-4 px-8">
                  <div className="flex items-center justify-between">
                    <span className="truncate pr-3 text-base font-small text-[#07074D] dark:text-gray-200">
                      {selectedFile?.name || "No file selected"}
                    </span>
                    <button
                      className="text-[#07074D] dark:text-gray-200"
                  ...
                  {fileUploadProgress != 100 ? (
                    <div className="relative mt-5 h-[6px] w-full rounded-lg bg-[#E2E5EF] dark:bg-gray-600">
                      <div
                        style={{ width: `${fileUploadProgress}%` }}
                        className="hover:shadow-form rounded-md bg-[#6A64F1] dark:bg-indigo-600 py-1 px-8 text-center text-base font-semibold text-white outline-none"
                      ></div>
                    </div>
                  ) : (
                    <svg
            ...
            <div>
              <button className="hover:shadow-form w-full rounded-md bg-[#6A64F1] dark:bg-indigo-600 py-3 px-8 text-center text-base font-semibold text-white outline-none">
