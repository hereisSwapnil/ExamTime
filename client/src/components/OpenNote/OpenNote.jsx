  ...
  return (
    <div>
...

      {
        isLoading ? <Loader />
          :
          <div className='flex justify-center items-start mt-7 ' style={{minHeight:"70vh"}}>
            <div className="grid w-1/2 grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8 h-0 mb-4">
